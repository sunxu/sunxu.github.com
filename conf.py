...
DEPLOY_COMMANDS = [
    ...
    'nikola build',
    'git init output',
    'git {git_dir} remote add origin \
            git@github.com:sunxu/sunxu.github.com.git'.format(git_dir=GIT_DIR),
    'git {git_dir} push origin :master; true'.format(git_dir=GIT_DIR),
    'git {git_dir} add .'.format(git_dir=GIT_DIR),
    'git {git_dir} commit -m "auto deployed by nikola"'.format(git_dir=GIT_DIR),
    'git {git_dir} push -u origin master'.format(git_dir=GIT_DIR),
]
